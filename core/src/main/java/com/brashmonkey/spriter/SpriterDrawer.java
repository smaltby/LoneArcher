...
public class SpriterDrawer extends Drawer<Sprite>
{
	...
	public void draw(Object object)
	{
		...
		File file = loader.data.getFile(object.ref.folder, object.ref.file);
		if(file.name.equals("Body.png") || file.name.equals("Hand.png"))
			sprite.setColor(Global.batch.getColor());
		else
